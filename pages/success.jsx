...
export default function Success() {
    ...
    return (
        <main className="min-h-screen grid place-items-center app-bg p-4 sm:p-6">
            <section className="card w-full max-w-2xl text-center backdrop-blur-xl border border-white/20 shadow-2xl">
                    ...
                    <ul className="text-sm text-blue-950 dark:text-blue-100 space-y-4 text-left">
                        ...
                        <li className="flex items-start gap-3 bg-white/60 dark:bg-blue-900/30 p-4 rounded-xl border border-blue-100 dark:border-blue-800/50 transition-all hover:shadow-md hover:border-blue-300 dark:hover:border-blue-700">
                            ...
                            <div className="flex-1">
                                ...
                                <a
                                    href="https://bus-manager-navy.vercel.app/"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="btn-base btn-primary w-full sm:w-auto text-sm py-2 no-underline"
                                >
                                    <span className="text-lg">💺</span>
